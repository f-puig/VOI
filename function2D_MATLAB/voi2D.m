function [filtered_NMR,VOImatrix,indexes,array_peaks]=voi2D(NMR,thresh,minvoi)
...
%// 3. Look for connected pixels in temp matrix.
for row = 1 : rows
    for col = 1 : cols
